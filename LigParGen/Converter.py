...
from LigParGen.Orca2CM5charges import LoadModel, GetLogFile, HirshfeldToCM5, AddCM5Charges, BoltzmannAverageCharges
...
def convert(**kwargs):
    ...
    if qorca != None:
        ...
        if isinstance(qorca, list):
            # Already a list of files (from nargs='+' or API call)
            log_files = []
